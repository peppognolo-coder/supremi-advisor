...
interface Props {
  ...
  salette?: Saletta[];
  /**
   * Se true, la card è espansa al mount.
   * Usato da SaletteScreen quando si arriva dalla Home → "Segnala problema".
   * Non modifica il comportamento normale (default: false).
   */
...
export default function SalettaCard({
  ...
  // Inizializzato con initialExpanded: al mount la card è già aperta
  // se viene richiesto dall'esterno. useState usa il valore iniziale
  // una sola volta — nessun useEffect necessario.
